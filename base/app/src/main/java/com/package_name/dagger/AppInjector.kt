...
object AppInjector {
     ...
     */
    private fun registerActivityLifeCycleCallbacks(chatbotApp : ChatbotApp) {
        chatbotApp.registerActivityLifecycleCallbacks(object : Application.ActivityLifecycleCallbacks {
